  ...
  return (
    <>
      <div id='main'>
        <nav>
          <div className='navi'>
            <svg className="core-logo" xmlns="http://www.w3.org/2000/svg" width="94" height="21" viewBox="0 0 94 21">
        ...
        <div className='loader'>
          ...
          <div className="yellow2 page1"></div>
          <video
            muted autoPlay loop
            src="https://works.studio/uploads/images/home/4_version1_200911_024106.mp4"></video>
        ...
        <div className='page2' >
          <div className='page2-loader' ref={page2Ref}>
            <div className="elem" data-img="https://works.studio/assets/imager/images/mineral-health/38349/MIN-1_240208_000417_1a58980f77ae6d8c6a1e26c40e92a05d.jpg" ref={(thisDiv) => (elemsRef.current[0] = thisDiv)}
            >
              <h1>Mineral</h1>
            ...
            <div className="elem" data-img="https://works.studio/assets/imager/images/erthos-brand-identity/43075/Home-Featured-Image_1a58980f77ae6d8c6a1e26c40e92a05d.jpg" ref={(thisDiv) => (elemsRef.current[1] = thisDiv)}>
              <h1>Erthos</h1>
              <div className="moving">
                <div className="blur"></div>
                <div className="moving-in">
            ...
            <div className="elem" data-img="https://works.studio/assets/imager/images/converse-global-fa23/43403/converse-21_240523_143223_1a58980f77ae6d8c6a1e26c40e92a05d.jpg" ref={(thisDiv) => (elemsRef.current[2] = thisDiv)}>
              <h1>Converse</h1>
              <div className="moving">
                <div className="blur"></div>
                <div className="moving-in">
            ...
            <div className="elem" data-img="https://works.studio/assets/imager/images/skky-partners/37986/skky-25_1a58980f77ae6d8c6a1e26c40e92a05d.jpg" ref={(thisDiv) => (elemsRef.current[3] = thisDiv)}>
              <h1>Skky</h1>
              <div className="moving">
                <div className="blur"></div>
                <div className="moving-in">
            ...
            <div className="elem" data-img="https://works.studio/assets/imager/images/boldly/37287/BOLDLY-1_1a58980f77ae6d8c6a1e26c40e92a05d.jpg" ref={(thisDiv) => (elemsRef.current[4] = thisDiv)}>
              <h1>Boldly</h1>
              <div className="moving">
                <div className="blur"></div>
                <div className="moving-in">
          ...
          <div className="img-container">
            <div className="line">
              <div className="img-div">
                <div className="black">
                  <p>Converse <br /> <em> nextStudio</em> </p>
                </div>
                <img src="https://works.studio/assets/imager/images/futurevvorld/38020/fvv-1.5_e49f8295ccc5a85e1a76e2d68c06456f.jpg" />
              </div>
              <div className="img-div">
                <div className="black">
                  <p>Converse <br /> <em> nextStudio</em> </p>
                </div>
                <img src="https://works.studio/assets/imager/images/versace-trigerca-identity/38005/versace-1.5_e49f8295ccc5a85e1a76e2d68c06456f.jpg" />
              </div>
              <div className="img-div">
                <div className="black">
                  <p>Converse <br /> <em> nextStudio</em> </p>
                </div>
                <img src="https://works.studio/assets/imager/images/the-north-face-climb-festival/41520/Thumbnail_e49f8295ccc5a85e1a76e2d68c06456f.jpg" />
              </div>
            </div>
            <div className="line">
              <div className="img-div">
                ...
                <img src="https://works.studio/assets/imager/images/converse/38120/v1.5-converse-bball-3_e49f8295ccc5a85e1a76e2d68c06456f.jpg" />
              </div>
              <div className="img-div">
                <div className="black">
                  <p>Converse <br /> <em> nextStudio</em> </p>
                </div>
                <img src="https://works.studio/assets/imager/images/us-soccer/21753/NewThumb_e49f8295ccc5a85e1a76e2d68c06456f.jpg" />
              </div>
              <div className="img-div">
                <div className="black">
                  <p>Converse <br /> <em> nextStudio</em> </p>
                </div>
                <img src="https://works.studio/assets/imager/images/between-places/40495/W%C3%98RKS_BetweenPlaces_Cover_240219_231911_e49f8295ccc5a85e1a76e2d68c06456f.jpg" />
              </div>
            ...
            <div className="line">
              <div className="img-div sec">
                ...
                <img src="https://works.studio/assets/imager/images/converse-basketball-ho19/1766/Converse-Basketball-Identity-Shoe-Photgraphy_WORKS_e49f8295ccc5a85e1a76e2d68c06456f.jpg" />
              </div>
              <div className="img-div">
                <div className="black">
                  <p>Converse <br /> <em> nextStudio</em> </p>
                </div>
                <img src="https://works.studio/assets/imager/images/nike-air-max-day-21-nyc-identity/38233/amd-v1.5_e49f8295ccc5a85e1a76e2d68c06456f.jpg" />
              </div>
              <div className="img-div">
                <div className="black">
                  <p>Converse <br /> <em> nextStudio</em> </p>
                </div>
                <img src="https://works.studio/assets/imager/images/de-cara-al-sol-book-design/39377/W%C3%98RKS_DeCaraAlSol_Cover_e49f8295ccc5a85e1a76e2d68c06456f.jpg" />
              </div>
